...
def start_game():
    global score
    pause("You find yourself in a forest full of predatory animals and tall grasses called the Cursed Forest")
    pause("You remember some rumors that this forest has strange monsters and witches")
    pause("Rumors say that no one enters or leaves the forest unless he is dead")
...
def explore_the_forset():
    global score
    pause("you started walking and exploring the forest and heard some voices, so you followed her")
    pause("I found a wizard chanting spells, and when I stood on a tree branch, it made a sound that made the wizard see me.")
...
def stay_where_your_self():
    global score
    pause("You are now standing in your place, night has fallen upon you, and creatures that fear the light have appeared.")
...
def run_away():
    global score
    pause("You start running while making a sound of fear, and one of the monsters hears you and starts chasing you.")
...
def ask():
    global score
    pause("You begin to ask the wizard about this forest with fear and hesitation")
    pause("He answers you and says: 'This forest is enchanted, filled with many nocturnal monsters, and it is rare to find a monster during the day")
    pause("You need to find shelter, and I will give you a magical staff that grants you some abilities to survive")
...
def fire():
    ...
    pause("1. You go to the wizard's house and ask him about something.\n2. Continues walking")
    choice = int(input("Enter your choice (1 or 2)\n"))
    while True:
        if choice == 1:
            score += 10
...
def attack():
    ...
    pause("You start waving your staff to see what abilities it will grant you")
    if wand == 'kill':
...
def stay():
    ...
    while True:
        answer = int(input("Enter your answer (1, 2, 3, 4, ......, or 12):\n"))
        if answer == 12:
            pause("Congratulations to you")
            score = 100
            ...
            pause("Due to your incorrect answer, your score is now less than 100.")
            pause("Your score is equal " + str(score))
...
def continue_explore():
    ...
    pause("You start asking about how to get out of the forest and if he has a map for that or not.")
    pause("When you start negotiating with the merchant for the map, he informs you that he's willing to provide the map but in exchange for your magical staff")
    pause("Do you accept or not? (1 'for yes' or 2 'for no)") 
    while True:
        choice = int(input("Enter your choice: \n"))
        if choice == 1:
            pause("You gave the merchant your staff and took the map.")
            pause("You start walking and exit the forest, meeting your friends. With that, you have succeeded.")
            pause("Your score now equal " + str(score))
            pause("But to win, your points must equal 100.")
            pause("Otherwise, you won't win")
            pause("To win, you must solve that riddle")
